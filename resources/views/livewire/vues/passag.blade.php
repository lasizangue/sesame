<div class="row p-4 pt-5" >
    ...
    <div class="card" style="width: 100%;">
                <div class="card-header p-2">
                        ...
                        @if($editDossier["dateNavire"]!="")
                            <li class="nav-item"><a class="nav-link" href="#pmlivraison" data-toggle="tab">Prépa. mise en livraison</a></li>
                        @endif
                        @if($editDossier["dateMiseEnLivraison"]!="")
                            <li class="nav-item"><a class="nav-link" href="#mlivraison" data-toggle="tab">Mise en livraison</a></li>
                        @endif

                            <li class="nav-item"><a class="nav-link" href="#livraison" data-toggle="tab">Livraison</a></li>
                            <li class="nav-item"><a class="nav-link active" href="#passage" data-toggle="tab">Passage</a></li>
                        </ul>
                </div>
               <div class="card-body">
...
<div class="tab-pane" id="mlivraison">
                ...
                <div class="col-4">
                    <div class="form-group" >
                     ...
                     <div class="col-4">
                        ...
                        <input type="date" wire:model="editDossier.dateLivraison" class="form-control" disabled>
                        </div>
                    </div>
    ...
    @else
                        <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title"><i class="nav-icon fas fa-folder-plus fa-lg mr-1"></i>Informations du bordereau de livraison aérien</h3>
        ...
        <div class="card-body" >
            <div class="row">
             ...
             <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                    <label>Client</label>
                    <select wire:model="editDossier.client_id" class="form-control" disabled>
                                <option value="">---------</option>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group" >
                        <label>Compagnie</label>
                            <select wire:model="editDossier.compagnie_id" class="form-control" disabled>
                                <option value="">---------</option>
                            @foreach ($compagnies as $compagnie)
                                <option value="{{$compagnie->id}}">{{$compagnie->nomCompagnie}}</option>
                            @endforeach
                ...
                <div class="col-6">
                    <div class="form-group">
                    <label>Vol</label>
                    <input type="text" wire:model="editDossier.vol" class="form-control" disabled>
            ...
            <div class="row">
                <div class="col-9">
                        ...
                        <input type="text" wire:model="editDossier.aeroportDepart" class="form-control" disabled>
                        </div>
                    </div>
                <div class="col-3">
                     <div class="form-group">
                        <label>Date arrivée:</label>
                            <input type="date" wire:model="editDossier.dateArrivee" class="form-control" disabled>
                    </div>
                </div>
    ...
    @endif
                        <div class="tab-pane active" id="passage">
                                    <div class="card card-orange">
                <div class="card-header">
                    <h3 class="card-title text-white"><i class="fa fa-user-graduate fa-lg mr-2"></i>Passage dossier</h3>
                </div>
        ...
        <form role= "form">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="date" wire:model="editDossier.datePassage" class="form-control" disabled>
             ...
             <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="date" wire:model="editDossier.dateBae" class="form-control" disabled>
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                        <label>N°BAE</label>
                        <input type="text" wire:model="editDossier.nBae" class="form-control" disabled>
                 ...
                 <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model="editDossier.bureauDouane" class="form-control" disabled>
             ...
             <div class="row">
                <div class="col-3">
                        <div class="form-group">
                                <label >Phyto</label>
                                    <input type="text" wire:model="editDossier.phyto" class="form-control" disabled>
                        </div>                 
                </div>
                 <div class="col-4">
                          <div class="form-group">
            ...
            <div class="card-footer float-right">
                <button type="button" class="btn btn-danger" wire:click.prevent='goToMenu()'>Retour</button>
            </div>
