<div class="row p-4 pt-5">
        <div class="card card-primary" style="width:100%">
                    ...
                    <h3 class="card-title"><i class="fas fa-book fa-lg"> RFCV VALIDE</i></h3>
                </div>
        <form role= "form" wire:submit.prevent='updateRfcv()' method="POST">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label class="mr-4 text-success"><input type="radio" wire:model="editRfcv.statut" value="Validé" class="form-control mt-3"> Validé</label>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="date" wire:model="editRfcv.dateRfcvVal" class="form-control">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label>N°Rfcv</label>
                            <input type="text" wire:model="editRfcv.numRfcvValide" class="form-control" onkeyup="this.value=this.value.toUpperCase()">
                        </div>
                    </div>
                </div>
