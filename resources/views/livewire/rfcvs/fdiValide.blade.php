<div class="row p-4 pt-5">
        <div class="card card-primary" style="width:100%">
                    ...
                    <h3 class="card-title"><i class="fas fa-book fa-lg"> FDI VALIDE</i></h3>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label>N°TC</label>
                            <input type="text" wire:model="editFdi.numFdiSoumi" class="form-control @error('editFdi.numFdiSoumi') is-invalid
                            @enderror" disabled>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            <label class="mr-4 text-success"><input type="radio" wire:model="editFdi.statut" value="Validé" class="form-control mt-3"> Validé</label>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label>Fdi validé le</label>
                            <input type="date" wire:model="editFdi.dateFdiVal" class="form-control">
                        </div>
                    </div>
                </div>
