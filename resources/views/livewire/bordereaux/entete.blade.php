                ...
                <td>
                        @if ($dossier->typeChargement=="TC Plein")
                                @if ($dossier->acconier->nomAcconier=="AGL" || $dossier->acconier->nomAcconier=="Delmas")
                                    <h4 class="mb-0 text-center">PREPA.MISE EN LIVRAISON :  {{ $dossier->numDossier }}</h4>
                                    @else
                                    <h4 class="mb-0 text-center">PREPA.MISE EN LIVRAISON TC IMPORT </h4>
                                @endif  
                        @endif
                        
                        @if ($dossier->typeChargement=="Degroupage")
                            <h4 class="mb-0 text-center">PREPA.MISE EN LIVRAISON (DGP)</h4>
                        @endif
