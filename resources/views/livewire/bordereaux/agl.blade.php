    ...
    <font size="2">Date réception : {{Carbon\Carbon::parse($dossier->dateReception)->format('d-m-Y') }}</font>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">Abidjan, le {{$dateHeureA}}</font>
                   
          <center><p class="mb-0 mt-0" style="border: 1px solid black;"><span ><font size="1"><b>PREPARATION DE MISE EN LIVRAISON</b></font></span></p></center>
          <p class="mb-0 ml-1"><font size="1">Date mise en livraison : <b>{{Carbon\Carbon::parse($dossier->dateMiseEnLivraison)->format('d-m-Y') }}</b></font></p>
          <p class="mb-0 ml-1"><font size="1">Transporteur : <b>{{$dossier->transporteur->nomTransporteur}}</b></font></p>
