                ...
                <hr class="mb-0 mt-0" style="border: 1px dashed black;"> 
                   <table  class="table border-top" style="border: 1px wihte;">
                          <tbody>                       
                                <tr>                          
                                    <td>
                                          <p class="mb-0 mt-0 ml-1"><font size="3">N°Déclaration : <b>{{$dossier->numDeclaration}}</b></font></p>
                                          
                                    </td>
                                    <td>
                                          <p class="mb-0 mt-0 ml-1"><font size="3">Circuit : <b>{{$dossier->circuit}}</b></font></p>
